...
$McAfeeCleanZipUrl  = "https://github.com/arictadm/set-autopilot/releases/download/mcafee-v1/mcafeeclean.zip"
$McCleanupZipUrl    = "https://github.com/arictadm/set-autopilot/releases/download/mcafee-v1/mccleanup.zip"
